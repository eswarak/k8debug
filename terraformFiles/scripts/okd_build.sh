...
sudo ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook /tmp/openshift-ansible/playbooks/prerequisites.yml -i /tmp/inventory.cfg 
...
sudo ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook /tmp/openshift-ansible/playbooks/deploy_cluster.yml -i /tmp/inventory.cfg 
